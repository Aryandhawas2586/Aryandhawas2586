...
| ⚙️ **DevOps** | • Linux<br>• Git<br>• GitHub<br>• Jenkins<br>• GitHub Actions<br>• CI/CD<br>• Bash<br>• Docker | • [Python Flask Server Deployment on AWS EC2 using Jenkins](YOUR_REPO_LINK)<br>• [AWS EC2 Deployment](YOUR_REPO_LINK) |
